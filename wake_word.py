...
def main():
    ...
    try:
        ...
        import os
        load_dotenv()
        api_key = os.getenv('API_PICO_VOICE')
    ...
    try:
        while True:
            ...
            if result >= 0:
                print('[%s] Detected "Hey Zyro"' % (str(datetime.now())))
                print('Offloading wakeword Model')
                ...
                import time
                print("model Offloaded, Check Perfomance History")
                time.sleep(5)
